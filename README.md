...
| | c'est ce qui permet de de charger les package et le --save permet de faire les dépendances (normalement le --save n'est pas obligatoire mais je l'ai laissé)  |
